                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="{{ route('admin.translations.create') }}" class="btn btn-primary waves-effect waves-light">
                            ...
                            <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.translations.edit', $translation->id) }}" 
                                               class="btn btn-primary btn-sm waves-effect waves-light">
                                                <i class="ri-pencil-line"></i>
                                            </a>
                                            <button type="button" 
                                                    class="btn btn-danger btn-sm waves-effect waves-light"
                                                    onclick="deleteData({{ $translation->id }})">
                                                <i class="ri-delete-bin-line"></i>
                                            </button>
                                            <form id="delete-form-{{ $translation->id }}" 
                                                  action="{{ route('admin.translations.destroy', $translation->id) }}" 
