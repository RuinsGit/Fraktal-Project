...
@section('title', 'Yeni Kurs Yolu Əlavə Et')

@section('content')
    <div class="container-fluid" style="margin-top: 100px;">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Yeni Kurs Yolu Əlavə Et</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.course-route.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="text_az">Mətn (AZ)</label>
                                <input type="text" name="text_az" id="text_az" class="form-control @error('text_az') is-invalid @enderror" value="{{ old('text_az') }}" required>
                                @error('text_az')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="text_en" id="text_en" class="form-control @error('text_en') is-invalid @enderror" value="{{ old('text_en') }}" required>
                                @error('text_en')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="text_ru" id="text_ru" class="form-control @error('text_ru') is-invalid @enderror" value="{{ old('text_ru') }}" required>
                                @error('text_ru')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
