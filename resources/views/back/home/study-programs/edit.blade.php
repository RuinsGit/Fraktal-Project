...
@section('title', 'Təhsil Proqramı Redaktə Et')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Təhsil Proqramı Redaktə Et</h4>
                                ...
                                <div class="tab-content p-3">
                                    ...
                                    <div class="tab-pane active" id="az" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name_az" class="form-control" value="{{ old('name_az', $program->name_az) }}" required>
                                            @error('name_az')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="text_az" class="form-control summernote">{{ old('text_az', $program->text_az) }}</textarea>
                                            @error('text_az')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_az" class="form-control summernote">{{ old('description_az', $program->description_az) }}</textarea>
                                    ...
                                    <div class="tab-pane" id="en" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name_en" class="form-control" value="{{ old('name_en', $program->name_en) }}" required>
                                            @error('name_en')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="text_en" class="form-control summernote">{{ old('text_en', $program->text_en) }}</textarea>
                                            @error('text_en')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_en" class="form-control summernote">{{ old('description_en', $program->description_en) }}</textarea>
                                    ...
                                    <div class="tab-pane" id="ru" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name_ru" class="form-control" value="{{ old('name_ru', $program->name_ru) }}" required>
                                            @error('name_ru')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="text_ru" class="form-control summernote">{{ old('text_ru', $program->text_ru) }}</textarea>
                                            @error('text_ru')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_ru" class="form-control summernote">{{ old('description_ru', $program->description_ru) }}</textarea>
